...
(function() {
  ...
  this.CreateStamenMap = function() {
    var StamenMapTypeOptions;
    return StamenMapTypeOptions = new google.maps.ImageMapType({
    ...
    this.serviceObject.mapTypes.set("WATERCOLOR", StamenMapTypeOptions);
    return this.serviceObject.setMapTypeId("WATERCOLOR");
  };
